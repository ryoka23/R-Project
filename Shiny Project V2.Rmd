...
```
```{r, echo=FALSE}
tags$img(src = "www/spotify_logo_black.png", height = "80px")
```
```{r}
getwd()
```
...
# Example (this may need to be adjusted based on your actual data):
# plot_data <- data.frame(
#     streams = spotify$streams,
#     predicted_streams = predict(cv_model, newdata = spotify),
#     conf_low = 0, # Replace with actual values
#     conf_high = 0, # Replace with actual values
#     pred_low = 0, # Replace with actual values
#     pred_high = 0 # Replace with actual values
# )
