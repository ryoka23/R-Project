...
ui <- navbarPage(
  title = div(
    img(src = "spotify_logo_black.png", height = "30px", style = "margin-top:-5px;"),
  ...
  tabPanel("Home",
    fluidPage(
      tags$div(
        ...
        img(src = "spotify_logo_green.png", height = "120px"),
        h2("Welcome to the Spotify Data Dashboard"),
        p("Dive into insights powered by Spotify song data."),
        tags$ul(
...
ui <- fluidPage(
  tags$h2("Home Page"),
  img(src = "spotify_logo_green.png", height = "80px"),
  p("Welcome to the Spotify Explorer App!")
)
